...
class MeshSplitter:
    ...
    def split(self):
        ...
        A = BodyMesh(vertices, positive, self.originalMesh.cell_type, var)
        B = BodyMesh(vertices, negative, self.originalMesh.cell_type, var)
        C = FaceMesh(vertices, face_cells, 'triangle', var)
