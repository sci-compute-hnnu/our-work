...
from Solve.BEM_FMM._3D_const_BEM_FMM import BEM_3DCESolver_FMM
...
class BEMSolverWindow(SolverWindow):
    ...
    def start_(self, button):
        ...
        # 加载求解器
        self.Connector.load_solver(BEM_3DCESolver_FMM(self.selectedMeshClass))

        self.Connector.DetectorWithRealTime()
